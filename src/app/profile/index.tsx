      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-medium hover:shadow-strong transition-all duration-300 border border-gray-100 hover:border-amber-200 group cursor-default"
            >
              ...
              <p className="text-4xl lg:text-5xl font-bold text-gray-900 mb-2">{stats?.xp || 0}</p>
              <p className="text-gray-600 font-medium text-sm lg:text-base">Total XP</p>
            ...
            <motion.div
              variants={itemVariants}
              className="bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-medium hover:shadow-strong transition-all duration-300 border border-gray-100 hover:border-orange-200 group cursor-default"
            >
              ...
              <p className="text-4xl lg:text-5xl font-bold text-gray-900 mb-2">{stats?.streak || 0}</p>
              <p className="text-gray-600 font-medium text-sm lg:text-base">Dagers Streak</p>
              <p className="text-xs text-gray-500 mt-2">🔥 Hold det gående!</p>
            </motion.div>

            {/* Lessons */}
            <motion.div
              variants={itemVariants}
              className="bg-white rounded-2xl lg:rounded-3xl p-6 lg:p-8 shadow-medium hover:shadow-strong transition-all duration-300 border border-gray-100 hover:border-brand-light group cursor-default"
            >
              ...
              <p className="text-4xl lg:text-5xl font-bold text-gray-900 mb-2">{totalLessonsCompleted}</p>
              <p className="text-gray-600 font-medium text-sm lg:text-base">Leksjoner</p>
              <p className="text-xs text-gray-500 mt-2">Fullført</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-4xl lg:text-5xl font-bold text-gray-900 mb-2">{totalStars}</p>
              <p className="text-gray-600 font-medium text-sm lg:text-base">Stjerner</p>
              <p className="text-xs text-gray-500 mt-2">Samlet</p>
            </motion.div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            >
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100/50 rounded-2xl p-6 hover:shadow-md transition-all cursor-default group">
                ...
                <p className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">{stats?.hearts || 0}</p>
                <p className="text-sm font-semibold text-gray-700 mb-2">{t('profile.hearts')}</p>
                <p className="text-xs text-gray-600">Gjenværende liv</p>
              </div>

              {/* XP */}
              <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 rounded-2xl p-6 hover:shadow-md transition-all cursor-default group">
                <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center mb-4 shadow-sm group-hover:shadow-lg group-hover:scale-110 transition-all">
                  <TrendingUp className="w-7 h-7 text-amber-600" />
                </div>
                <p className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">{stats?.xp || 0}</p>
                <p className="text-sm font-semibold text-gray-700 mb-2">{t('profile.xp')}</p>
                <p className="text-xs text-gray-600">Erfaringspoeng</p>
              </div>

              {/* Perfect Scores */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-2xl p-6 hover:shadow-md transition-all cursor-default group">
                <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center mb-4 shadow-sm group-hover:shadow-lg group-hover:scale-110 transition-all">
                ...
                <p className="text-sm font-semibold text-gray-700 mb-2">Perfekte</p>
                <p className="text-xs text-gray-600">3 stjerner</p>
              </div>

              {/* Lessons */}
              <div className="bg-gradient-to-br from-brand/10 to-brand/20 rounded-2xl p-6 hover:shadow-md transition-all cursor-default group">
                <div className="w-14 h-14 bg-white rounded-xl flex items-center justify-center mb-4 shadow-sm group-hover:shadow-lg group-hover:scale-110 transition-all">
                  <Trophy className="w-7 h-7 text-brand" />
                </div>
                <p className="text-3xl lg:text-4xl font-bold text-gray-900 mb-1">{totalLessonsCompleted}</p>
          ...
          <motion.div
            variants={itemVariants}
            className="bg-white rounded-3xl shadow-medium border border-gray-100 overflow-hidden"
          >
            <button
              onClick={handleSignOut}
              className="w-full p-6 lg:p-8 flex items-center justify-between hover:bg-red-50 transition-colors group"
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <span className="font-semibold text-lg text-red-600 block">{t('profile.signOut')}</span>
                  <span className="text-sm text-gray-600">Logg ut av kontoen din</span>
                </div>
              </div>
