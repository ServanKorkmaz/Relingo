-- Complete Translation Keys Update for All Lessons
-- This replaces all hardcoded Norwegian text with i18n translation keys
...
-- Verify the changes
SELECT slug, title, description, title_key, description_key 
FROM public.lessons 
ORDER BY religion_id, order_index;
